...
/// <summary>
/// Provides extensions to <see cref="IConfigurationBuilder"/> for adding <see cref="SettingsFileConfigurationSource"/>.
/// </summary>
public static class SettingsFileConfigurationBuilderExtensions
{
    private const string ConfigurationFileName = "Mafin.Configuration.json";

    private static readonly string DefaultSettingsFile = Path.Combine(Environment.CurrentDirectory, ConfigurationFileName);
